...
import 'package:kiemtra_he181356/Reposistory//ProductDAO.dart';
import 'package:kiemtra_he181356/Views/Pages/ProductDetailPage.dart';
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          "\$${(product.price * (1 - product.discountPercent / 100)).toStringAsFixed(0)}",
                        ),
                      ],
                    ),
                  ],
